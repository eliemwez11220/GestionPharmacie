...
class Intrant extends CI_Controller{
    ...
    function add()
    {
        ...
        if($this->form_validation->run())
        {
            ...
            $this->Educazad_model->insert_data('tb_im_produits',$params);
    ...
    function edit($intrantID)
    {
        ...
        $data['intrant'] = $this->Educazad_model->get_one_row('tb_im_produits', array('intrant_id'=>$intrantID));
        ...
        if(isset($data['intrant']))
        {
            ...
            if($this->form_validation->run())
            {
                ...
                $this->Educazad_model->update_data('tb_im_produits',$params, array('intrant_id'=>$intrantID));
                redirect('intrant/index');
            }
            else
            {
