...
<head>
    ...
    <title><?= $title ? $title : 'Bienvenue' ?> | gestionPharmacie Applicattion !</title>
            ...
            <div class="hpanel">
                <div class="panel-body">
                    <div class="text-center m-b-md custom-login">
                        ...
                        <?php } else { ?>
                            <b>gestionPharmacie Application</b>!
                    ...
                    <form action="<?= base_url('authenticate/login'); ?>" id="loginForm" method="post">
                        <div class="form-group">
                            ...
                            <input type="text" placeholder="pseudo ou yourname@gmail.com" title="Please enter your username or your email address"
                ...
                <div class="col-sm-6">
                    <div class="float-left text-left">
                        ...
                        <img src="<?= base_url(); ?>global/img/logo/coding.png"
                            ...
                            | <a href="https://congoagile.com" style="background-color: transparent; color: white; font-weight: bold;">gestionPharmacie Application</a>
                        </span>
                    </div>
                </div>
                <div class="col-sm-6" >
                    <div class="float-right text-right" style="margin-right: 10px!important;">
                        ...
                        <span class="small" style="background-color: transparent; color: #ffffff; font-weight: bold;">
                            gestionPharmacie et son logo sont des marques déposées de
